...
public class MainController {
    ...
    // @PutMapping("/students/{id}")
    // public Students updateStudent(@PathVariable("id") Long id, @RequestBody
    // Students student){
    // return studentService.updateStudent(id, student);
    // }
    @PutMapping("/students/CQQ{id}")
    public Students update(@PathVariable("id") Long id, @RequestBody Students student) {
        return studentService.updateStudent(id, student);
    }
